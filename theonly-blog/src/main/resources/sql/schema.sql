...
CREATE TABLE IF NOT EXISTS `tb_category` (
  ...
  `parent_id` varchar(32) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '父级分类id；null：父级',
...
CREATE TABLE IF NOT EXISTS `tb_post_category` (
  ...
  `category_id` varchar(32) COLLATE utf8mb4_bin NOT NULL COMMENT '分类id',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后修改时间',
  `deleted` tinyint(4) DEFAULT '0' COMMENT '是否已删除（回收站）',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE IF NOT EXISTS `tb_post_tag` (
  `id` varchar(32) COLLATE utf8mb4_bin NOT NULL,
  `post_id` varchar(32) COLLATE utf8mb4_bin NOT NULL COMMENT '文章id',
  `tag_id` varchar(32) COLLATE utf8mb4_bin NOT NULL COMMENT '标签id',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后修改时间',
  `deleted` tinyint(4) DEFAULT '0' COMMENT '是否已删除（回收站）',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE IF NOT EXISTS `tb_comment` (
  ...
  `parent_id` varchar(32) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '父级评论id（null：该评论是一级评论）',
  `post_id` varchar(32) COLLATE utf8mb4_bin NOT NULL COMMENT '文章id',
...
CREATE TABLE IF NOT EXISTS `tb_menu` (
  ...
  `parent_id` varchar(32) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '父级菜单（null：一级菜单）',
