...
import top.guoshihua.blog.domain.IPLocation;
...
public class IPAddressUtils {
     ...
     * 纯真IP数据库保存的文件夹
     */
    private String INSTALL_DIR="D:\\Devtools\\qqwry\\";
    ...
    public IPAddressUtils(String fileName, String dir)  {
...
//        byte[] data = Files.readAllBytes(Paths.get("D:\\Devtools\\纯真数据库\\qqwry.dat"));
//        QQWry qqwry = new QQWry(data); // create QQWry with provided data
//        QQWry qqwry = new QQWry();
//        QQWry qqwry = new QQWry(Paths.get("D:\\Devtools\\纯真数据库\\qqwry.dat"));
        QQWry qqwry = new QQWry();
